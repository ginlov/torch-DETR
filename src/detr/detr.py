...
class DETR(torch.nn.Module):
    ...
    def __init__(self, backbone, transformer, d_model, num_classes, num_queries):
        ...
        self.conv_project = torch.nn.Conv2d(backbone.out_channels, d_model, kernel_size=1)
...
def build_detr(backbone_name, num_classes, num_queries, d_model=256, nhead=8, num_encoder_layers=6, num_decoder_layers=6, dim_feedforward=2048, dropout=0.1):
    """
    ...
    transformer = Transformer(d_model, nhead, num_encoder_layers, num_decoder_layers, dim_feedforward, dropout)
